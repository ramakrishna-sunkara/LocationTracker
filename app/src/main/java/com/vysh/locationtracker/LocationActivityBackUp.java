...
public class LocationActivityBackUp extends AppCompatActivity implements
        LocationListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        llShowTripList.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(LocationActivityBackUp.this,TripListActivity.class);
    ...
    public void onMyTripDetailsFetched(TripModel tripModel) {
        Intent intent = new Intent(LocationActivityBackUp.this, TripReviewActivity.class);
